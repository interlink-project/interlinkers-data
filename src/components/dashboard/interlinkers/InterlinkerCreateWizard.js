...
import InterlinkerDescriptionForm from './InterlinkerDescriptionForm';
import InterlinkerDetailsForm from './InterlinkerDetailsForm';
import InterlinkerOwnerForm from './InterlinkerOwnerForm';

const InterlinkerCreateWizard = (props) => {
...
export default InterlinkerCreateWizard;
