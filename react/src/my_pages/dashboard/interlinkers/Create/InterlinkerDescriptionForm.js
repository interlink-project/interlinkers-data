...
import QuillEditor from '../../../../tm_components/QuillEditor';

const InterlinkerDescriptionForm = (props) => {
...
InterlinkerDescriptionForm.propTypes = {
  onBack: PropTypes.func,
  onComplete: PropTypes.func
};

export default InterlinkerDescriptionForm;
