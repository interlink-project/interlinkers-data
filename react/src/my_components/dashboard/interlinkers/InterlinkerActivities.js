...
import InterlinkerActivity from './InterlinkerActivity';

const InterlinkerActivities = (props) => {
...
InterlinkerActivities.propTypes = {
  activities: PropTypes.array.isRequired
};

export default InterlinkerActivities;
