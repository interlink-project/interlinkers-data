...
const InterlinkerApplicationModal = (props) => {
    ...
    >
      <Box sx={{ p: 3 }}>
        <Typography
          ...
          variant='h4'
        >
          The interlinker requires an introduction
        </Typography>
        <Typography
          align='center'
          color='textSecondary'
        ...
        <Box sx={{ mt: 3 }}>
          <TextField
            ...
            placeholder='What excites you about this interlinker?'
            rows={5}
            value={value}
            variant='outlined'
          />
...
InterlinkerApplicationModal.propTypes = {
...
export default InterlinkerApplicationModal;
