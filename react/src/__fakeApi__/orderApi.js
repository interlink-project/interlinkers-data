    ...
    const orders = [
      {
        ...
        currency: '$',
        customer: {
          email: 'carson.darrin@interlink.io',
          name: 'Carson Darrin'
        },
        number: 'DEV-102',
      ...
      },
      {
        ...
        currency: '$',
        customer: {
          email: 'jie.yan.song@interlink.io',
          name: 'Jie Yan Song'
        },
        number: 'DEV-100',
        paymentMethod: 'CreditCard',
      ...
      },
      {
        ...
        currency: '$',
        customer: {
          email: 'clarke.gillebert@interlink.io',
      ...
      },
      {
        ...
        currency: '$',
        customer: {
          email: 'miron.vitold@interlink.io',
          name: 'Miron Vitold'
        },
        number: 'DEV-98',
        paymentMethod: 'PayPal',
      ...
      },
      {
        ...
        customer: {
          name: 'Penjani Inyene',
          email: 'penjani.inyene@interlink.io'
        },
        status: 'pending',
        number: 'DEV-97',
        paymentMethod: 'CreditCard',
      ...
      },
      {
        ...
        currency: '$',
        customer: {
          email: 'omar.darobe@interlink.io',
          name: 'Omar Darobe'
        },
        number: 'DEV-96',
        paymentMethod: 'CreditCard',
      ...
      },
      {
        ...
        currency: '$',
        customer: {
          email: 'siegbert.gottfried@interlink.io',
      ...
      },
      {
        ...
        currency: '$',
        customer: {
          email: 'nasimiyu.danai@interlink.io',
          name: 'Nasimiyu Danai'
        },
        number: 'DEV-93',
        paymentMethod: 'PayPal',
